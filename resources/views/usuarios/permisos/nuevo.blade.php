<x-adminlte-modal id="nuevoPermiso" title="Nuevo Permiso" size="md" theme="primary" icon="fas fa-user-cog" v-centered static-backdrop scrollable>
    <div class="container-fluid row">
        ...
        <div class="col-lg-12 p-1">
            <form class="form-group">
                <x-adminlte-input type="text" id="nombre" name="nombre" placeholder="*Permiso de usuario">
